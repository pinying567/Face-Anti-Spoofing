...
from dataset_img_task1 import AntiSpoofingDataset
from model_task1 import CNN
...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_dir', type=str, default='checkpoint/cnn_task1', help='directory to save logfile, checkpoint and output csv')
